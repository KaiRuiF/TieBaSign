...
def main():
    ...
    #     return
    # b = ENV['BDUSS'].split('#')
    b = ['V0eUZ5Y0haMWlrbXRnNWV1cW9hU3h-ZXJlVE5zYWdsYlBtcHNuOFBWYnRUSXBoRVFBQUFBJCQAAAAAAAAAAAEAAAAgeHsVMTA4NTkwNjYwNgAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAO2~YmHtv2Jham']
